...
# Ruta del video
video_path = 'videos\\zzzby.mp4'  # Asegúrate de que sea un archivo de video válido
cap = cv.VideoCapture(video_path)

lower = np.array([0, 50, 40])  # Límite inferior
upper = np.array([170, 255, 255])  # Límite superior
    ...
    if contours:
        ...
        if radius > 10:
            ...
            if img2.size > 0:
                ...
                cv.imwrite(f'images/bocho/zzzby_{i}.jpg', img2)
                i += 1
